...
export default function ContactPage() {
  ...
  const [formStatus, setFormStatus] = useState(null); // To manage form submission status
    ...
    <main className="bg-gray-900 text-white min-h-screen flex flex-col">
      ...
      <section className="flex flex-col items-center justify-center text-center mt-32 px-6 py-12 max-w-6xl mx-auto">
        ...
        <motion.form
          ...
          className="mt-12 space-y-6 max-w-3xl w-full bg-gray-800 p-8 rounded-xl shadow-xl"
        >
          <div className="space-y-4">
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                required
                className="mt-2 p-4 bg-gray-700 rounded-lg text-gray-200 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-400 transition"
          ...
          <motion.button
            ...
            className="w-full py-4 mt-4 bg-yellow-400 text-gray-900 font-semibold text-lg rounded-lg shadow-lg transform transition duration-500 ease-out hover:scale-105 hover:bg-yellow-500 hover:shadow-2xl"
          >
